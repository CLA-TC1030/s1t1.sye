...
debugtest: 
	g++ -fsanitize=address --std=c++17 test/tests.cpp test/chkFiles.cpp Game.cpp CDado.cpp Jugador.cpp Tablero.cpp CCasilla.cpp CasillaNormal.cpp CasillaEscalera.cpp CasillaSerpiente.cpp -g -o build/dexercise
